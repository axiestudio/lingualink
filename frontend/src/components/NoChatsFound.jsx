...
function NoChatsFound() {
  ...
  return (
    <div className="flex flex-col items-center justify-center py-10 text-center space-y-4">
      ...
      <div>
        <h4 className="text-slate-200 font-medium mb-1">Ready to connect globally?</h4>
        <p className="text-slate-400 text-sm px-6">
          Start breaking language barriers! Select a contact to begin messaging with real-time translation.
        </p>
      </div>
      <button
